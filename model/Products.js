...
products.addProduct({
  ...
  category: 'eletronics',
  price: 96.59,
  description: `CT16G4SFD8266 is a 16GB DDR4 Notebook module that operates at speeds up to 2666 MT/s and has a CL19 latency. It is an Unbuffered SODIMM. It conforms to the industry standard DDR4 SODIMM layout of 260 pins and is compatible with systems that take DDR4 2666MT/s SODIMM memory.`,
...
products.addProduct({
  ...
  category: 'eletronics',
  price: 24.99,
  description: `Console-style control for your PC games - Experience the console-style gaming you crave on your PC with the Gamepad F310. Easy to use with its familiar shape and layout, it supports new games and old favorites. Programmable controls allow for a more custom experience, while its floating D-pad enables quick response. Just plug it in and get ready to play the way you like: to win.`,
...
products.addProduct({
  ...
  category: 'hobbies',
  price: 59.99,
  description: `Fiery Battles and Deep Shadows. What strange fires lurk in the shadows? Minions of Team Skull and a cavalcade of new Pokémon stand ready to battle in the dark of night and in the blazing sun. Slug it out with new titans like Necrozma-GX and Tapu Fini-GX, or battle with trusty allies from Machamp-GX and Charizard-GX to Darkrai-GX and Ho-Oh-GX. Fight for what’s right with the Pokémon TCG: Sun and Moon-Burning Shadows expansion. `,
...
products.addProduct({
  ...
  category: 'hobbies',
  price: 24.99,
  description: `An innovator in providing fantasy entertainment, Dungeons & Dragons is the wellspring for the entire modern game industry, digital as well as tabletop. Fifth edition D&D draws from every prior edition to create a universally compelling play experience, and exemplifies the true spirit of a game that holds captive the hearts and minds of millions of players worldwide. The core rulebook series consists of three books: the Player’s Handbook, the Monster Manual, and the Dungeon Master’s Guide. `,
